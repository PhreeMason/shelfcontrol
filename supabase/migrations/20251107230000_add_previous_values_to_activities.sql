-- Add previous_progress and previous_status to get_daily_activities
-- This allows showing deltas for progress updates and status transitions
...
'Aggregates all user activities (deadlines due, deadlines created, progress updates, status changes, notes, reviews) for a date range. Includes previous_progress and previous_status for showing deltas and transitions. Used by calendar view for performance optimization.';
