 ...
 */
export const CustomDateCalendarCard: React.FC<CustomDateCalendarCardProps> = React.memo(
    function CustomDateCalendarCard({ agendaItem, onPress }) {
        ...
        const customDateName = activity.metadata?.custom_date_name || 'Important Date';
