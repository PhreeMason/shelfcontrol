  ...
  if (isLoadingBookDetails) {
    return (
      <View style={styles.loadingOverlay}>
        <ActivityIndicator size="large" color={colors.primary} />
        <ThemedText variant="muted" style={styles.loadingOverlayText}>
  ...
  return (
    <View style={styles.container}>
      <ThemedText color="textMuted" style={styles.description}>
        Let's add a book to track. We'll calculate your daily reading pace to
      ...
      <View style={styles.manualEntryContainer}>
        <View style={[styles.divider, { backgroundColor: colors.border }]}>
          <ThemedText color="textMuted" style={styles.dividerText}>
            OR
          </ThemedText>
        </View>
      </View>
